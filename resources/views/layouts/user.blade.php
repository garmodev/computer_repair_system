    ...
    <div  class="  card shadow-sm p-2 mb-5 bg-white rounded mt-4" style="margin-left: 15%">
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                @endif
                @if (request()->routeIs('NotifyRepairComputer.index'))
                <li class="nav-item">
                    <a class="nav-link active" href="{{ route('NotifyRepairComputer.index') }}">
                        <div
                            class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="fas fa-calendar-alt text-warning text-sm opacity-10"></i>
                        </div>
                        <span class="nav-link-text ms-1">แจ้งซ่อมเครื่องคอมพิวเตอร์</span>
                    </a>
                </li>
            @else
                <li class="nav-item">
                    <a class="nav-link " href="{{ route('NotifyRepairComputer.index') }}">
                        <div
                            class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="fas fa-calendar-alt text-warning text-sm opacity-10"></i>
                        </div>
            ...
            @if (request()->routeIs('NnotifyController.index'))
            <li class="nav-item">
                <a class="nav-link active" href="{{ route('NnotifyController.index') }}">
                    <div
                        class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="fas fa-calendar-alt text-warning text-sm opacity-10"></i>
                    </div>
                    <span class="nav-link-text ms-1">รายการซ่อม</span>
                </a>
            </li>
        @else
            <li class="nav-item">
                <a class="nav-link " href="{{ route('NnotifyController.index') }}">
                    <div
                        class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="fas fa-calendar-alt text-warning text-sm opacity-10"></i>
                    </div>
                ...
                <nav aria-label="breadcrumb">
                    ...
                    @if (request()->routeIs('NnotifyController.index'))
                        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                            ...
                            <li class="breadcrumb-item text-sm text-dark " aria-current="page">รายการซ่อม
                    ...
                    @if (request()->routeIs('NotifyRepairComputer.index'))
                        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                            ...
                            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">แจ้งซ่อมคอมพิวเตอร์
    ...
    <div class="fixed-plugin">
        ...
        <div class="card shadow-lg">
            <div class="card-header pb-0 pt-3 ">
                <div class="float-start float-center text-center">
